...
- `src/components/memorial/` — כל הרכיבים של דף ההנצחה הציבורי (תעודת זהות,
  סיפור חיים, מדיה, תהילים, יום השנה, מצבה, שיתוף, ברקוד).
...
- דף הנצחה ציבורי מעוצב עם ניווט עוגן (ראשי / מי אני / תהילים / מדיה), תעודת
  זהות, תאריך עברי מחושב אוטומטית, יום השנה הבא + ספירה לאחור + הוספה ליומן
  (ICS) + שיתוף ב-WhatsApp, תמונת מצבה עם ניווט, וכפתורי שיתוף לרשתות.
